...
```jsonc
  "configFile": {
    ...
    // Имя сервиса или список имён, которые будут перезапущены после сохранения файла с настройками
    ...
    // Если true, после сохранения настроек, homeui будет заново их запрашивать у wb-mqtt-confed 
    "needReload": true,
  }
```